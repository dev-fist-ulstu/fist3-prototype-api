...
from modules.document.models import Document, DocumentLikes, DocumentDislikes
...
class ToggleReaction(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        like = DocumentLikes.objects.get_or_create(user_id=request.user.id)[0]
        dislike = DocumentDislikes.objects.get_or_create(user_id=request.user.id)[0]
        if btn_clicked == "like":
